...
| T-008-04 | `scripts/docs_check.py` required set + README sections; `scripts/fresh_clone_test.py` + `make fresh-clone-test`; test | FR-008-01/02, AC-1/2 | `uv run pytest tests/test_docs_check.py && make fresh-clone-test` | ☐ |
| T-008-05 | README EN: docs index, badge, Prior art & acknowledgments, How we built it, limitations, screenshot placeholder; `README.es.md`; `docs/es/quickstart.md` | FR-008-04, AC-4 | `make docs-check` | ☐ |
| T-008-06 | `docs/devpost.md`, `docs/video-script.md` (+ SRT export procedure) | FR-008-05, AC-5 | `make docs-check` | ☐ |
| T-008-07 | Converge; STATE.md; H3b request; tag `v0.2.0` after H3 | Art. III.3 | `make verify && make fresh-clone-test` | ☐ |

## Definition of Done
- [ ] All tasks ☑ · `make verify` + `make docs-check` + `make fresh-clone-test` green · CI green · STATE.md updated
